...
public class Runner {
    ...
    private static List<RunnableTest> getRunnableTests(Class<?> cls, String nameFilter) {
        List<RunnableTest> rts = new ArrayList<>();
        for (Method m : cls.getMethods()) {
            if (!m.getName().toLowerCase().contains(nameFilter.toLowerCase())) {
                continue;
            }
    ...
    private static List<RunnableTest> getRunnableTests(String[] args, String nameFilter) throws ClassNotFoundException {
        List<RunnableTest> rts = new ArrayList<>();
        for (String arg : args) {
            String testName = arg;
            ...
            rts.addAll(getRunnableTests(Class.forName(testName), nameFilter));
        }
        return rts;
    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        List<RunnableTest> allTests = getRunnableTests(args, nameFilter);
